					...
					if(stageMap[w]==s-1){ 
                       ...
                       for(t=0;t<No_year[s-1];t++){
						...
						//take care of the rest of g
							if (s< No_stage-1){
								for(k=0;k<nCut+1;k++){ 
									...
									g[w][j][nCut]+=lambda*g[decendant[w][j]][varIndex[decendant[w][j]][k]][k]*pi_Cut1[decendant[w][j]][k];
									...
									for(i=0;i<No_recharge; i++){
										...
										g[w][j][nCut] -= lambda*psi_eta[decendant[w][j]][k]*pi_Cut1[decendant[w][j]][k]*H[decendant[w][j]][k][i]*storage_hat[i][decendant[w][j]][k]/(1-alpha);
									}
						...
						for(i=0;i<No_recharge; i++){
							...
							for(j=0;j<No_scen;j++){
								...
								for(i=0;i<No_recharge; i++){
									...
									CutLhs1[w][nCut][i]+=lambda*H[w][nCut][i];
									CutLhs1[w][nCut][i]+=lambda*psi_eta[w][nCut]*H[w][nCut][i]/(1-alpha);
						...
						for(i=0;i<No_recharge; i++){
							...
							CutRhs1[w][nCut]-=lambda*psi_eta[w][nCut]*H[w][nCut][i]*storage_hat[i][w][nCut]/(1-alpha);
						}
						CutRhs1[w][nCut]+=lambda*g[w][varIndex[w][nCut]][nCut];
